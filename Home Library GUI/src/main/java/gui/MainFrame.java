...
public class MainFrame extends JFrame {
	...
	private JMenu createReportMenu() {
		...
		r3.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				flipPageTo(new ReportBooksWithSimilarTopic());
		...
		r6.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				HashMap<String, ArrayList<String>> table = DatabaseConnectionReportApi.generateMultiSkillsMovieCrew();
				flipPageTo(new ViewFilterResultPanel(table));
		...
		r9.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				HashMap<String, ArrayList<String>> table = DatabaseConnectionReportApi.generateMultiSkillMusicCrew();
				flipPageTo(new ViewFilterResultPanel(table));
		...
		r10.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				HashMap<String, ArrayList<String>> table = DatabaseConnectionReportApi.generateSimilarNames();
				flipPageTo(new ViewFilterResultPanel(table));
